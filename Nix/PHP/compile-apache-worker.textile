...
El módulo apache worker implementa un modelo híbrido multihilo mutliproceso permitiendo servir un gran número de peticiones usando menor número de recursos que el módulo prefork por tanto es una opción factible si su sitio tiene problemas de carga.
