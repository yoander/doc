...
Go to http://php.net site Downloads section and select the PHP-6.X.X version that you want to compile (5.6.11 at time of writing this articule), select your nearest mirror and downloat it or simply type in your console

```bash
$ wget $ wget http://us1.php.net/distributions/php-5.6.11.tar.xz
```
